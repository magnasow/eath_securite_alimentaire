    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorizeRequests ->
                        authorizeRequests
                                .requestMatchers("/auth/register", "/auth/login", "/auth/registerAdmin").permitAll() // Permet l'accès public aux routes d'inscription et de connexion
                                .requestMatchers("/api/administrateurs/**").permitAll() // Accès réservé aux administrateurs
                                .requestMatchers("/api/utilisateurs/**").permitAll()// Accès réservé aux utilisateurs
